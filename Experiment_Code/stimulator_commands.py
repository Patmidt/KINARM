...
"""Connection handler for serial device"""


class Serial_Connection:

    def __init__(self, COMPORT, msgLen):
        self.MESSAGE_LENGTH = msgLen
        self.serialPort = COMPORT
        self.serialDevice = serial.Serial(
            port=self.serialPort, baudrate=115200, bytesize=8, timeout=2, stopbits=serial.STOPBITS_ONE)
